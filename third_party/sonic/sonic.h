...
#define sonicCreateStream avp_ae_sonic_core_create_stream
#define sonicDestroyStream avp_ae_sonic_core_destroy_stream
#define sonicWriteFloatToStream avp_ae_sonic_core_write_float_to_stream
#define sonicWriteShortToStream avp_ae_sonic_core_write_short_to_stream
#define sonicWriteUnsignedCharToStream avp_ae_sonic_core_write_unsigned_char_to_stream
#define sonicReadFloatFromStream avp_ae_sonic_core_read_float_from_stream
#define sonicReadShortFromStream avp_ae_sonic_core_read_short_from_stream
#define sonicReadUnsignedCharFromStream avp_ae_sonic_core_read_unsigned_char_from_stream
#define sonicFlushStream avp_ae_sonic_core_flush_stream
#define sonicSamplesAvailable avp_ae_sonic_core_samples_available
#define sonicGetSpeed avp_ae_sonic_core_get_speed
#define sonicSetSpeed avp_ae_sonic_core_set_speed
#define sonicGetPitch avp_ae_sonic_core_get_pitch
#define sonicSetPitch avp_ae_sonic_core_set_pitch
#define sonicGetRate avp_ae_sonic_core_get_rate
#define sonicSetRate avp_ae_sonic_core_set_rate
#define sonicGetVolume avp_ae_sonic_core_get_volume
#define sonicSetVolume avp_ae_sonic_core_set_volume
#define sonicGetChordPitch avp_ae_sonic_core_get_chord_pitch
#define sonicSetChordPitch avp_ae_sonic_core_set_chord_pitch
#define sonicGetQuality avp_ae_sonic_core_get_quality
#define sonicSetQuality avp_ae_sonic_core_set_quality
#define sonicGetSampleRate avp_ae_sonic_core_get_sample_rate
#define sonicSetSampleRate avp_ae_sonic_core_set_sample_rate
#define sonicGetNumChannels avp_ae_sonic_core_get_num_channels
#define sonicSetNumChannels avp_ae_sonic_core_set_num_channels
#define sonicChangeFloatSpeed avp_ae_sonic_core_change_float_speed
#define sonicChangeShortSpeed avp_ae_sonic_core_change_short_speed
#define sonicComputeSpectrogram avp_ae_sonic_core_compute_spectrogram
#define sonicGetSpectrogram avp_ae_sonic_core_get_spectrogram
#define sonicCreateSpectrogram avp_ae_sonic_core_create_spectrogram
#define sonicDestroySpectrogram avp_ae_sonic_core_destroy_spectrogram
#define sonicConvertSpectrogramToBitmap avp_ae_sonic_core_convert_spectrogram_to_bitmap
#define sonicDestroyBitmap avp_ae_sonic_core_destroy_bitmap
#define sonicWritePGM avp_ae_sonic_core_write_pgm
#define sonicAddPitchPeriodToSpectrogram avp_ae_sonic_core_add_pitch_period_to_spectrogram
