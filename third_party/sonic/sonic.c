...
#define malloc(size) avp_malloc(size)
#define calloc(nmemb, size) avp_calloc((nmemb), (size))
#define realloc(ptr, size) avp_realloc((ptr), (size))
#define free(ptr) avp_free(ptr)
