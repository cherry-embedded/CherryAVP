/* Standalone Sonic example for raw 44.1 kHz stereo S16LE PCM. */
#include <math.h>
#include <stdlib.h>
...
int main(int argc, char **argv)
{
    ...
    printf("sonic done: blocks=%u, in_frames=%u, out_frames=%u, sample_rate=%u, channels=%u, speed=%.3f, pitch=%.3f, rate=%.3f\n",
